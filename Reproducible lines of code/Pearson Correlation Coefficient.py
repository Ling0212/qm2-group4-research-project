...
# We now define our x and y variables, corresponding to the columns Total Electricity Generation per Capita and Life Expectancy in the imported .csv file. With spicy.stats library, we calculate the Pearson correlation coefficient as presented in the following lines of code:
